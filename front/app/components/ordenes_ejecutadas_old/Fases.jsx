...
const Fases = ({ proms, setFaseSave, fase_save, fase_list, l_produccions }) => {
          ...
          try {
            lista.forms = JSON.stringify(
              JSON.parse(lista.forms).map((form) => ({
                ...
                linea_produccion: localStorage.getItem("linea_produccion"),
              }))
            );
            ...
            localStorage.removeItem("linea_produccion");
          } catch (e) {
            console.log(e);
          }
        };
