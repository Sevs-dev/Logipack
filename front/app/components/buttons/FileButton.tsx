    ...
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-2 p-1.5">
      ...
      {files.length === 0 && (
        <label
          ...
          className={`flex flex-col items-center justify-center w-full flex-1 min-h-[80px] px-3 py-2 border-2 rounded-md cursor-pointer transition-all duration-200 text-center shadow-sm text-xs ${dragOver
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="truncate" title={f.file.name}>
                      {f.file.name}
                    </p>
