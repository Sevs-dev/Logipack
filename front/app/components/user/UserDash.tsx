    ...
    <div>
      ...
      <WindowManager
        windowsData={[
          ...
          { id: 2, title: "Productos", component: <PermissionWrapper fallback={<NonePermission />}><Products /></PermissionWrapper>, isProtected: true },
          { id: 3, title: "Lineas", component: <PermissionWrapper fallback={<NonePermission />}><Lista /></PermissionWrapper>, isProtected: true },
